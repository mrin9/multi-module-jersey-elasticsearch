...
var AppConfig = /** @class */ (function () {
    function AppConfig() {
        ...
        if (this.apiHostName.includes("infomud") || this.apiHostName.includes("heroku")) {
            ...
            this.baseApiPath = this.apiProtocol + "//" + this.apiHostName + ":" + this.apiPort + "/api/";
        }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_clarity_angular__ = __webpack_require__("../../../../clarity-angular/clarity-angular.es5.js");
